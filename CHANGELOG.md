...
- A canonical `Makefile` for local formatting, linting, testing, auditing,
  documentation, and release tasks
- A `git-perms(1)` manpage covering the CLI, `.gitperms` format, hooks, and
  exit statuses
...
- README documentation now describes the library-plus-binary package and the
